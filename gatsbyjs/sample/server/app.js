...
var routes = function (app, callback)
{
    ...
    app.get("/api/images/:id", function(req, res) {
        ...
        req.branch(function(err, branch) {
            ...
            .then(function() {
                res.redirect("/static/" + this._doc + "-image.jpg?repository=" + this.getRepositoryId() + "&branch=" + this.getBranchId() + "&node=" + this.getId());
            });
        })
    });

    app.get("/api/pdfs/:id", function(req, res) {
        const id = req.params.id;
        ...
        req.branch(function(err, branch) {
            ...
            .then(function() {
                res.redirect("/static/" + this._doc + "-pdf.pdf?repository=" + this.getRepositoryId() + "&branch=" + this.getBranchId() + "&node=" + this.getId() + "&attachment=book_pdf");
            });
        })
    });
